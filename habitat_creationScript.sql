...
CREATE TABLE IF NOT EXISTS `Habitat`.`Eventos` (
  ...
  `projecto` INT NULL,
  `valorAngariado` DECIMAL(10,2) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `Habitat`.`Doacoes` (
  ...
  INDEX `fk_Doacoes_Projectos1_idx` (`projecto` ASC),
  ...
  CONSTRAINT `fk_Doacoes_Eventos1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Doacoes_Projectos1`
    FOREIGN KEY (`projecto`)
    REFERENCES `Habitat`.`Projectos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Habitat`.`Anexos` (
  ...
  `candidatura` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Anexos_Candidaturas1_idx` (`candidatura` ASC),
  CONSTRAINT `fk_Anexos_Candidaturas1`
    FOREIGN KEY (`candidatura`)
    REFERENCES `Habitat`.`Candidaturas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Habitat`.`CandidaturaPerguntas` (
  ...
  INDEX `fk_CandidaturaPerguntas_Perguntas1_idx` (`pergunta` ASC),
...
-- -----------------------------------------------------
-- Table `Habitat`.`VoluntariosEquipas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Habitat`.`VoluntariosEquipas` (
  `voluntario` INT NOT NULL,
  `equipa` INT NOT NULL,
  INDEX `fk_VoluntariosEquipas_Voluntarios1_idx` (`voluntario` ASC),
  INDEX `fk_VoluntariosEquipas_Equipas1_idx` (`equipa` ASC),
  PRIMARY KEY (`voluntario`, `equipa`),
  CONSTRAINT `fk_VoluntariosEquipas_Voluntarios1`
    FOREIGN KEY (`voluntario`)
    REFERENCES `Habitat`.`Voluntarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_VoluntariosEquipas_Equipas1`
    FOREIGN KEY (`equipa`)
