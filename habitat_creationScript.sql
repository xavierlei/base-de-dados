...
CREATE TABLE IF NOT EXISTS `mydb`.`Projectos` (
  ...
  CONSTRAINT `fk_Projectos_Candidaturas1`
    ...
    REFERENCES `mydb`.`Candidaturas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`CandidaturaPerguntas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`CandidaturaPerguntas` (
